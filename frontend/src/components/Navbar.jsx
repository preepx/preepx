    ...
    <nav className="navbar">
      <div className="navbar-inner">
        <Link to={user ? "/interview" : "/"} className="navbar-brand" style={{ display: 'flex', alignItems: 'center', height: '100%' }}>
          <img src="/preepx_logo.png" alt="PreepX" className="brand-logo-img" style={{ height: "40px", transform: "scale(2.5)", transformOrigin: "left center", objectFit: "contain", marginLeft: "10px", marginTop: "8px" }} />
        </Link>
